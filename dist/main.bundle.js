...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _style_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./style.css */ \"./src/style.css\");\n/* harmony import */ var _modules_scoresMethods_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/scoresMethods.js */ \"./src/modules/scoresMethods.js\");\n/* harmony import */ var _modules_ui_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/ui.js */ \"./src/modules/ui.js\");\n\n\n\n\nconst manageData = async () => {\n  const data = await _modules_scoresMethods_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].getScores();\n  const x = data.filter(\n    (x) => Number(x.score) <= 1000 && Number(x.score) >= 0,\n  );\n  x.sort((a, b) => b.score - a.score);\n  const top = x.slice(0, 1000);\n  _modules_ui_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"].render(top);\n};\n\nconst form = document.getElementById('form');\nform.addEventListener('submit', (e) => {\n  e.preventDefault();\n  const user = document.getElementById('player').value;\n  const score = document.getElementById('playerScore').value;\n  _modules_scoresMethods_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].addScore(user, score);\n  form.reset();\n});\n\nconst refreshBtn = document.getElementById('refresh');\nrefreshBtn.addEventListener('click', () => {\n  manageData();\n});\n\n\n//# sourceURL=webpack://leaderboard/./src/index.js?");
